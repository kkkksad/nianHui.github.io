<template>
  <div id="tool">
    <el-button class="YearButton" @click="startHandler" type="primary" size="mini">
      <img
        :src="running ? 'https://s3.springbeetle.com/prod-us2-bucket/trantor/attachments/US/nianHui-stopButton.png' : 'https://s3.springbeetle.com/prod-us2-bucket/trantor/attachments/US/nianHui-startButton.png'"
        alt="" />
    </el-button>
